  ...
  schema-compare:
    ...
    steps:
      ...
      - name: 📊 Display Results
        run: |
          echo "## 📊 Schema Comparison Results" >> $GITHUB_STEP_SUMMARY
      ...
      - name: 💬 Comment on PR (if differences found)
        ...
        with:
          script: |
            ...
            const body = `## 🚨 Database Schema Differences Detected
      ...
      - name: ✅ Success Notification
        ...
        run: |
          ...
          echo "## ✅ Schemas In Sync" >> $GITHUB_STEP_SUMMARY
